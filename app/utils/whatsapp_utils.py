...
def generate_response(response):
    ...
    if "train" in response and "u" in response and "tube" not in response and "com" not in response  and len(response)<=30 and "video" not in user_input.lower() and "document" not in user_input.lower() and "module" not in user_input.lower() and "processing" not in user_input.lower() and "recognition" not in user_input.lower()and "model" not in user_input.lower():
        return "I was created by Tanishq Ravula"
    if "image" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower() "document" not in user_input.lower() and "module" not in user_input.lower() and "processing" not in user_input.lower() and "recognition" not in user_input.lower() and "model" not in user_input.lower() and "process" not in user_input.lower() and "train" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower() and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "picture" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower() and "document" not in user_input.lower() and "module" not in user_input.lower() and "processing" not in user_input.lower() and "recognition" not in user_input.lower() and "model" not in user_input.lower() and "process" not in user_input.lower() and "train" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "images" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower() "document" not in user_input.lower() and "train" not in user_input.lower() and "create" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "pictures" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower()  and "document" not in user_input.lower()and "train" not in user_input.lower() and "create" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "photo" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower() and "document" not in user_input.lower() and "module" not in user_input.lower() and "processing" not in user_input.lower() and "recognition" not in user_input.lower() and "model" not in user_input.lower() and "process" not in user_input.lower() and "train" not in user_input.lower()  and "develop" not in user_input.lower() and "test" not in user_input.lower()and "train" not in user_input.lower() and "create" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "photos" in user_input.lower() and "video" not in user_input.lower() and "generating" not in user_input.lower()and "document" not in user_input.lower()and "train" not in user_input.lower() and "create" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
        return create_design(user_input)
    if "video" in user_input.lower() and "document" not in user_input.lower() and "document" not in user_input.lower() and "module" not in user_input.lower() and "processing" not in user_input.lower() and "recognition" not in user_input.lower() and "model" not in user_input.lower() and "process" not in user_input.lower()and "train" not in user_input.lower() and "create" not in user_input.lower() and "develop" not in user_input.lower() and "test" not in user_input.lower()and "visualise" not in user_input.lower() and "visualize" not in user_input.lower() and "visualization" not in user_input.lower() and "visualisation" not in user_input.lower():
